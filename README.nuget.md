...
[![NuGet Version](https://img.shields.io/nuget/v/Mango.Libbpf?label=NuGet)](https://www.nuget.org/packages/Mango.Libbpf/)
[![NuGet Downloads](https://img.shields.io/nuget/dt/Mango.Libbpf)](https://www.nuget.org/packages/Mango.Libbpf/)
![.NET 10](https://img.shields.io/badge/.NET-10.0-512BD4)
![Linux only](https://img.shields.io/badge/platform-linux-orange)
...
Packed and published to NuGet as `Mango.Libbpf` on pushing a `v*` tag (see [`.github/workflows/publish-nuget.yml`](https://github.com/Yekuuun/Mango/blob/main/.github/workflows/publish-nuget.yml)).

---

## Resources

- [GitHub repository](https://github.com/Yekuuun/Mango)
...
MIT — see [`LICENSE`](https://github.com/Yekuuun/Mango/blob/main/LICENSE).
